    ...
    public class PaisController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pais != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Pais'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sobrenome,Email,Senha,Cpf")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome,Email,Senha,Cpf")] Pais pais)
        {
            if (id != pais.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Pais'  is null.");
            }
            var pais = await _context.Pais.FindAsync(id);
            if (pais != null)
            {
